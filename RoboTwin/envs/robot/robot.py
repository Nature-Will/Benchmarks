...
class Robot:
    ...
    def set_planner(self, scene=None):
        ...
        if self.need_topp:
            # Pass scene=None to avoid SapienPlanningWorld segfault in
            # mplib + sapien 3.0.0b1.  The basic mplib.Planner still
            # provides TOPP; CuroboPlanner handles motion planning.
