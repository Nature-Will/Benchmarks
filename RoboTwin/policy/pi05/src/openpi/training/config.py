...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader("/mnt/shared-storage-user/p1-shared/yujiale/code/benchmarks/RoboTwin/policy/pi05/checkpoints/pi05_aloha_full_base/pi05_base/30000/params"),
        num_train_steps=20_000,
        batch_size=64,
        fsdp_devices=2,  # H200 80GB x2
    ),
    # pi0_base by lora
    TrainConfig(
